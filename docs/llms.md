...
* **`source` (Obligatory):**
  ...
  * **Option 1 (Terraform Registry - Recommended for Users):** `kube-hetzner/kube-hetzner/hcloud`
    ...
    * **`version`:** It's highly recommended to pin the module version (e.g., `version = "3.0.2"`). This ensures:
